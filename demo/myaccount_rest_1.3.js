...
ultracart.MyAccount = function (merchantId) {
   ...
   * @param [options] success and failure callbacks
   * @return if no callbacks specified, this returns back a text message informing customer to check email (on success), else null
   */
  this.createAccount = function (customerInformation, options) {
    ...
    jQuery.ajax({
      url: '/rest/myaccount/settings' + (params != null ? ('?' + params) : ''),
